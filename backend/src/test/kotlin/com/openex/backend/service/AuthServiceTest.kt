...
class AuthServiceTest {
    ...
    fun `register creates a new user and returns JWT`() {
        ...
        val savedUser = User(id = UUID.randomUUID(), username = "alice", email = "alice@ex.com", passwordHash = "hashed")
    ...
    fun `login returns JWT for valid credentials`() {
        val user = User(id = UUID.randomUUID(), username = "bob", email = "bob@ex.com", passwordHash = "hashed")
